...
<style>
	.menu ol { padding-left:15px; border:#E7E7E7 1px solid; border-top:none;background: #BDBDBD;} 
...
<body style="background-color: #373a47;">
	<ul class="expmenu">
			...
			<li>
				<div class="header">
					<span class="left_span2">宠物管理</span>
					<span class="arrow down"></span>
				</div>
				<ul class="menu">
					<li><a href="getExamInfoDataList.action" target="show" title="试卷列表" class="left_span1">发帖信息</a></li>
				</ul>
				<hr size=1>
				<ul class="menu">
					<li><a href="getUserExamDataList.action" target="show" title="考试记录" class="left_span1">挑战记录</a></li>
				</ul>
			</li>
			<li>
				<div class="header">
				...
				<hr size=1>
				<ul class="menu">
					<li><a href="getScoreItemDataList.action" target="show" title="打分项设置" class="left_span1">统计分析</a></li>
				</ul>
