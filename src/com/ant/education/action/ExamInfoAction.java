...
import com.ant.education.entity.User;
import com.ant.education.entity.UserExam;
import com.ant.education.service.IExamInfoService;
import com.ant.education.service.IUserExamService;
	...
	public void inputExamFile() {
		...
		try {
			...
			if (examInfo != null) {
				...
				String addFilePath = System.currentTimeMillis() + ".doc";
