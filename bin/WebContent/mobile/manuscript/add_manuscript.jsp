<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- <%@ page import="com.ant.education.mobile.util.WeixinUtil" %>     --%>
...
<script type="text/javascript" src="<%=basePath%>mobile/manuscript/js/manuscript.js"></script>
...
<body>
    ...
    <form id="addManuscriptForm" action="saveManuscript.action" method="post">
		<table style="border-collapse:separate;width:100%;">
			<tr>
				<td class="td_left">投稿主题:</td>
				<td><input type="text" id="manuscript_theme" name="manuscript.manuscriptTheme" class="input-text" placeholder="请输入投稿主题"></td>
			</tr>
			<tr>
				<td class="td_left">投稿内容:</td>
				<td>
					<textarea rows="5" cols="30" style="width: 100%;" id="manuscript_content" name="manuscript.manuscriptContent"></textarea>
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center"><input type="button" id="save_manuscript" class="regBtn" value="保&nbsp;存" /></td>
			</tr>
		</table>
	</form>
</body>
...
<%-- <script src="<%=basePath%>manuscript/js/manuscript_wx.js"> </script>     --%>
</html>